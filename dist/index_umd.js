(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('mmvis')) :
	typeof define === 'function' && define.amd ? define(['mmvis'], factory) :
	(global = global || self, global.canvax = factory(global.mmvis));
}(this, function (mmvis) { 'use strict';
	...
	})(void 0, function (exports, _mmvis, _Matrix, _Point, _index, _AnimationFrame, _observe, _const$$1, _InsideLine, _settings) {
	    ...
	    _createClass(DisplayObject, [{
	      ...
	      value: function _createContext(opt) {
	        ...
	        _contextATTRS.$watch = function (name, value, preValue) {
	          ...
	          if (_mmvis._.indexOf(_const$$1.TRANSFORM_PROPS, name) > -1) {
	...
	(function (global, factory) {
	...
	})(void 0, function (exports, _const$$1, _settings, _AnimationFrame, _index, _mmvis) {
	  ...
	  var SystemRenderer = function () {
	    function SystemRenderer() {
	      var type = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : _const$$1.RENDERER_TYPE.UNKNOWN;
	...
	})(void 0, function (exports, _const$$1) {
	    ...
	    _createClass(CanvasGraphicsRenderer, [{
	      ...
	      value: function render(displayObject, stage, globalAlpha, isClip) {
	        ...
	        for (var i = 0; i < graphicsData.length; i++) {
	          ...
	          if (data.type === _const$$1.SHAPES.POLY) {
	            //只第一次需要beginPath()
	            ctx.beginPath();
	          ...
	          } else if (data.type === _const$$1.SHAPES.RECT) {
	            if (isClip) {
	              //ctx.beginPath();
	          ...
	          } else if (data.type === _const$$1.SHAPES.CIRC) {
	          ...
	          } else if (data.type === _const$$1.SHAPES.ELIP) {
	            var w = shape.width * 2;
	...
	(function (global, factory) {
	...
	})(void 0, function (exports, _SystemRenderer2, _const$$1, _GraphicsRenderer, _mmvis) {
	  ...
	  var CanvasRenderer = function (_SystemRenderer) {
	    ...
	    function CanvasRenderer(app) {
	      ...
	      _this = _possibleConstructorReturn(this, _getPrototypeOf(CanvasRenderer).call(this, _const$$1.RENDERER_TYPE.CANVAS, app, options));
	...
	(function (global, factory) {
	  ...
	  var Rectangle = function () {
	    function Rectangle() {
	      ...
	      this.width = width;
	      this.height = height;
	      this.type = _const$$1.SHAPES.RECT;
	      this.closed = true;
	    }
	...
	(function (global, factory) {
	...
	})(void 0, function (exports, _Rectangle, _const$$1) {
	  ...
	  var Circle = function () {
	    function Circle() {
	      ...
	      this.y = y;
	      this.radius = radius;
	      this.type = _const$$1.SHAPES.CIRC;
	      this.closed = true;
	    }
	...
	(function (global, factory) {
	  ...
	  var Ellipse = function () {
	    function Ellipse() {
	      ...
	      this.width = width;
	      this.height = height;
	      this.type = _const$$1.SHAPES.ELIP;
	      this.closed = true;
	    }
	...
	(function (global, factory) {
	  ...
	  var Polygon = function () {
	    function Polygon() {
	      ...
	      this.closed = true;
	      this.points = points;
	      this.type = _const$$1.SHAPES.POLY;
	    }
	...
	})(void 0, function (exports, _GraphicsData, _index, _const$$1, _bezierCurveTo2, _mmvis) {
	      ...
	      value: function updateLocalBounds() {
	        ...
	        if (this.graphicsData.length) {
	          ...
	          for (var i = 0; i < this.graphicsData.length; i++) {
	            ...
	            if (type === _const$$1.SHAPES.RECT || type === _const$$1.SHAPES.RREC) {
	            ...
	            } else if (type === _const$$1.SHAPES.CIRC) {
	              x = shape.x;
	              y = shape.y;
	              ...
	              maxY = y + h > maxY ? y + h : maxY;
	            } else if (type === _const$$1.SHAPES.ELIP) {
	              x = shape.x;
	              y = shape.y;
	...
	})(void 0, function (exports, _DisplayObject2, _index, _mmvis, _const$$1, _Graphics) {
	  ...
	  var Shape = function (_DisplayObject) {
	    ...
	    _createClass(Shape, [{
	      ...
	      value: function $watch(name, value, preValue) {
	        if (_mmvis._.indexOf(_const$$1.STYLE_PROPS, name) > -1) {
	...
	var Circle$2 = createCommonjsModule(function (module, exports) {
	...
	var Ellipse$2 = createCommonjsModule(function (module, exports) {
	...
	unwrapExports(Ellipse$2);

	var Polygon$2 = createCommonjsModule(function (module, exports) {
	...
	unwrapExports(Polygon$2);

	var Isogon = createCommonjsModule(function (module, exports) {

	(function (global, factory) {
	  {
	    factory(exports, Polygon$2, utils, mmvis, _Math);
	  }
	...
	(function (global, factory) {
	...
	})(void 0, function (exports, _Shape2, _index, _mmvis, _Math$$1) {
	  ...
	  var _Math2 = _interopRequireDefault(_Math$$1);
	...
	(function (global, factory) {
	  {
	    factory(exports, Application, DisplayObject, DisplayObjectContainer, Stage, Sprite, Shape, Point, Text, BrokenLine, Circle$2, Droplet, Ellipse$2, Isogon, Line, Path, Polygon$2, Rect, Sector, arrow, AnimationFrame, utils);
	  }
